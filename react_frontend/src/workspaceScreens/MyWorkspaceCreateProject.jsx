...
const RichTextToolbar = ({ onFormat }) => {
  return (
    <div className="flex items-center gap-0.5 px-3 py-1.5 bg-gray-50 dark:bg-[#1a1a24] border-b border-gray-200 dark:border-gray-800/60 rounded-t-xl flex-wrap">
      <button
        type="button"
...
const MyWorkspaceCreateProject = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0b0b10] flex flex-col md:flex-row">
      ...
      {/* ── Main Content ── */}
      <div className="flex-1 bg-white dark:bg-[#0f0f12] md:min-h-screen overflow-y-auto pb-24 md:pb-0">
        <div className="max-w-3xl mx-auto px-4 md:px-8 py-4 md:py-6">
          
          {/* ── Header ── */}
          <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-200/60 dark:border-gray-800/40">
            <button
              onClick={() => navigate(`/my-workspace/${workspaceId}/projects`)}
              className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800/30 rounded-xl transition text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-white"
            >
              <FaArrowLeft />
            </button>
            <div>
              <h1 className="text-xl font-bold text-gray-800 dark:text-gray-100">Create Project</h1>
              <p className="text-sm text-gray-500 dark:text-gray-400">Set up a new project for your workspace</p>
            </div>
          </div>

          <form onSubmit={handleSubmit} className="space-y-5">
            {/* ── Basic Information ── */}
            <div className="bg-white dark:bg-[#14141a] rounded-2xl p-5 border border-gray-200/60 dark:border-gray-800/60">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-white dark:bg-[#0b0b10] border border-gray-300 dark:border-gray-700/60 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 dark:focus:ring-[#0d9488] text-sm text-gray-800 dark:text-gray-200 placeholder-gray-500 dark:placeholder-gray-500"
                    required
                  />
                </div>
                <div>
            ...
            <div className="bg-white dark:bg-[#14141a] rounded-2xl p-5 border border-gray-200/60 dark:border-gray-800/60">
              ...
              <div className="bg-white dark:bg-[#0b0b10] border border-gray-200 dark:border-gray-800/60 rounded-xl overflow-hidden">
...
*Italic text*
> Quotes"
                  className="w-full px-4 py-3 text-sm focus:outline-none bg-white dark:bg-[#0b0b10] text-gray-800 dark:text-gray-200 placeholder-gray-500 dark:placeholder-gray-500 min-h-[150px] resize-y"
                  rows="6"
                />
                <div className="px-3 py-1.5 bg-gray-50 dark:bg-[#1a1a24] border-t border-gray-200 dark:border-gray-800/60 text-[10px] text-gray-500 dark:text-gray-500">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <button
                        ...
                        className={`flex-1 py-2 rounded-xl text-sm font-medium transition capitalize ${
                          priority === p
                            ...
                            : 'bg-white dark:bg-[#0b0b10] border border-gray-300 dark:border-gray-700/60 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800/30'
                        }`}
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2.5 bg-white dark:bg-[#0b0b10] border border-gray-300 dark:border-gray-700/60 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 dark:focus:ring-[#0d9488] text-sm text-gray-800 dark:text-gray-200"
                  >
            ...
            <div className="bg-white dark:bg-[#14141a] rounded-2xl p-5 border border-gray-200/60 dark:border-gray-800/60">
              ...
              <div className="flex items-center gap-4">
                {coverPreview ? (
                  ...
                  <label className="flex items-center gap-3 px-5 py-3 border-2 border-dashed border-gray-300 dark:border-gray-700/60 rounded-xl cursor-pointer hover:border-gray-400 dark:hover:border-gray-500 transition bg-white dark:bg-[#0b0b10]">
            ...
            <div className="bg-white dark:bg-[#14141a] rounded-2xl p-5 border border-gray-200/60 dark:border-gray-800/60">
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-white dark:bg-[#0b0b10] border border-gray-300 dark:border-gray-700/60 rounded-xl text-sm text-gray-700 dark:text-gray-300 file:mr-3 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-sm file:font-medium file:bg-gray-100 dark:file:bg-[#0d9488]/20 file:text-gray-700 dark:file:text-[#0d9488] hover:file:bg-gray-200 dark:hover:file:bg-[#0d9488]/30"
                accept=".pdf,.doc,.docx,.txt,.zip,.png,.jpg,.jpeg"
              />
              {documents.length > 0 && (
                <div className="mt-2 space-y-1">
                  {documents.map((doc, index) => (
                    <div key={index} className="flex items-center justify-between bg-gray-50 dark:bg-[#0b0b10] rounded-lg px-3 py-1.5 border border-gray-200 dark:border-gray-700/60">
                      <span className="text-sm text-gray-700 dark:text-gray-300 truncate max-w-[80%]">{doc.name}</span>
                      <button
                        type="button"
            ...
            {/* ── Actions ── */}
            <div className="flex gap-3 pt-4 border-t border-gray-200/60 dark:border-gray-800/40">
              <button
                type="button"
                onClick={() => navigate(`/my-workspace/${workspaceId}/projects`)}
                className="flex-1 py-3 border border-gray-300 dark:border-gray-700/60 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800/30 transition text-sm font-medium text-gray-700 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white"
              >
                Cancel
              </button>
              <button
