    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#0b0b10]/80 backdrop-blur-sm p-4">
      <div className="bg-[#14141a] border border-gray-800/60 rounded-2xl max-w-md w-full p-6 shadow-xl">
        <div className="flex justify-between items-center mb-4">
          ...
          <button onClick={onClose} className="p-1.5 text-gray-400 hover:text-white hover:bg-gray-800/60 rounded-lg transition">
            <FaTimes />
          </button>
        </div>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 bg-[#0b0b10] border border-gray-700/60 rounded-xl text-sm text-gray-200 focus:border-[#0d9488] outline-none"
              required
            />
          </div>
          <div>
          ...
          <div className="flex gap-3 pt-2">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 py-2 border border-gray-700/60 rounded-xl text-sm text-gray-400 hover:bg-gray-800/30 transition"
            >
              Cancel
            </button>
            <button
    ...
    <div className="group relative bg-[#14141a] rounded-2xl border border-gray-800/40 hover:border-[#0d9488]/50 transition-all duration-500 hover:shadow-[0_8px_40px_rgba(13,148,136,0.15)] overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-2 md:gap-3 mt-2 md:mt-3 text-[9px] md:text-[10px] text-gray-500">
          ...
          <span className="flex items-center gap-1">
            <FaCheckCircle className="text-[8px] md:text-[10px] text-green-400" />
