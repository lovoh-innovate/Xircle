      ...
      <div className="w-72 max-w-full h-full bg-white dark:bg-[#14141a] border-l border-gray-200 dark:border-gray-800/60 p-6 overflow-y-auto animate-slide-in-right">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full py-2 text-xs text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-white transition"
          >
            Reset Filters
          </button>
        </div>
  ...
  return (
    <div className="group relative bg-white dark:bg-[#14141a] rounded-2xl border border-gray-200 dark:border-gray-800/40 hover:border-[#0d9488]/50 transition-all duration-500 hover:shadow-[0_8px_40px_rgba(13,148,136,0.15)] overflow-hidden">
      ...
      <div className="relative h-20 md:h-28 bg-gray-100 dark:bg-[#1a1a24] overflow-hidden">
        ...
        <span
          className={`absolute top-2 right-2 text-[10px] font-medium px-2.5 py-1 rounded-full backdrop-blur-sm border ${statusColor[project.status]} bg-white/60 dark:bg-black/30 border-gray-200 dark:border-gray-700/50`}
        >
        ...
        <div className="absolute top-2 left-2">
          ...
          {showMenu && (
            <div className="absolute left-0 top-full mt-1 bg-white dark:bg-[#1e1e26] rounded-xl shadow-[0_8px_30px_rgba(0,0,0,0.8)] border border-gray-200 dark:border-gray-800/60 min-w-[130px] z-20 py-1">
              <button
                onClick={(e) => {
                  stopProp(e);
                  setShowMenu(false);
                ...
                className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-[#0d9488]/10 hover:text-gray-900 dark:hover:text-white transition w-full"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-red-500/10 hover:text-red-700 dark:hover:text-red-300 transition w-full"
              >
          ...
          <div className="flex items-center justify-between px-4 h-14 lg:h-16">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="hidden md:flex items-center gap-1.5 bg-gray-100 dark:bg-[#1a1a24] border border-gray-300 dark:border-gray-800/60 rounded-full px-3 py-1.5 text-xs text-gray-700 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:border-gray-400 dark:hover:border-gray-600 transition"
              >
              ...
              <button
                ...
                className="md:hidden p-1.5 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800/30 rounded-xl transition"
              >
              ...
              {/* Create project button (owner only) */}
              {isOwner && (
                <button
            ...
            {['all', 'planning', 'in-progress', 'completed', 'archived'].map((status) => (
              <button
                ...
                className={`text-xs px-3 py-1 rounded-full transition whitespace-nowrap ${
                  filters.status === status
                    ? 'bg-[#0d9488]/20 text-[#0d9488] border border-[#0d9488]/30'
                    : 'text-gray-600 dark:text-gray-500 hover:text-gray-800 dark:hover:text-gray-300 border border-transparent hover:border-gray-300 dark:hover:border-gray-700'
                }`}
              >
        ...
        <div className="flex-1 overflow-y-auto px-4 sm:px-6 lg:px-8 py-5 pb-28 md:pb-6">
          ...
          <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
            <div className="bg-white dark:bg-[#14141a] rounded-xl border border-gray-200 dark:border-gray-800/40 p-4 backdrop-blur-sm hover:border-[#0d9488]/30 transition group">
              <p className="text-2xl font-bold text-gray-800 dark:text-gray-100 group-hover:text-[#0d9488] transition">
                {totalProjects}
              </p>
            ...
            <div className="bg-white dark:bg-[#14141a] rounded-xl border border-gray-200 dark:border-gray-800/40 p-4 hover:border-blue-400 dark:hover:border-blue-500/30 transition group">
              <p className="text-2xl font-bold text-blue-600 dark:text-blue-400 group-hover:text-blue-500 dark:group-hover:text-blue-300 transition">
                {planningProjects}
              </p>
            ...
            <div className="bg-white dark:bg-[#14141a] rounded-xl border border-gray-200 dark:border-gray-800/40 p-4 hover:border-yellow-400 dark:hover:border-yellow-500/30 transition group">
              <p className="text-2xl font-bold text-yellow-600 dark:text-yellow-400 group-hover:text-yellow-500 dark:group-hover:text-yellow-300 transition">
                {inProgressProjects}
              </p>
            ...
            <div className="bg-white dark:bg-[#14141a] rounded-xl border border-gray-200 dark:border-gray-800/40 p-4 hover:border-green-400 dark:hover:border-green-500/30 transition group">
              <p className="text-2xl font-bold text-green-600 dark:text-green-400 group-hover:text-green-500 dark:group-hover:text-green-300 transition">
                {completedProjects}
              </p>
                ...
                <div className="mt-3 space-y-3">
                  {activeProjects.length === 0 ? (
                    ...
                    activeProjects.map((p) => (
                      <Link
                        key={p._id}
                        to={`/my-workspace/${workspaceId}/project/${p._id}`}
              ...
              <div className="bg-white dark:bg-[#14141a] rounded-2xl border border-gray-200 dark:border-gray-800/40 p-4">
                ...
                <div className="mt-3 flex items-center gap-4">
                  <div className="relative w-16 h-16">
                    ...
                    <span className="absolute inset-0 flex items-center justify-center text-xs font-bold text-gray-800 dark:text-gray-300">
                      {overallProgress}%
                    </span>
                  </div>
                  <div>
