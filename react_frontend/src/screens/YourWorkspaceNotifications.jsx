// src/screens/YourWorkspaceNotifications.jsx
...
const buildNotificationLink = (data = {}, fallbackWorkspaceId) => {
  ...
  if (data.chatId && wsId) {
    return `/workspace/${wsId}/chat/${data.chatId}`;
  }

  if (data.projectId && wsId) {
    return `/workspace/${wsId}/project/${data.projectId}`;
  }
...
const YourWorkspaceNotifications = () => {
          ...
          <div className="hidden md:flex items-center justify-between mb-6">
            <div>
              <Link
                ...
                className="text-[10px] text-gray-500 dark:text-gray-500 uppercase tracking-widest hover:text-teal-600 dark:hover:text-[#0d9488] transition-colors inline-flex items-center gap-1.5"
              >
...
export default YourWorkspaceNotifications;