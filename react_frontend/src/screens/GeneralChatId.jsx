...
// Previously: ["😂", "😊", "😍", "😡", "😢"]
// Now: 👍 ❤️ 😂 😍 😭 (❤️ uses the emoji-presentation codepoint so it
// matches the "❤️" entry already present in EMOJI_LIST and renders red
...
const GeneralChatId = () => {
  ...
  const handleAudioEnd = useCallback((endedId, nextAudioId) => {
    ...
    if (nextAudioId) {
      // auto-play logic is handled elsewhere
    }
